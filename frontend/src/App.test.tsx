...
describe('App', () => {
  ...
  it('compares original and upscaled image and highlights a completed job', async () => {
    ...
    expect(screen.getByAltText('До').parentElement).toHaveStyle({ clipPath: 'inset(0 25% 0 0)' })
    expect(screen.getByAltText('После').parentElement).toHaveStyle({ clipPath: 'inset(0 0 0 75%)' })
